...
| Lab 11 | MVP Implementation Sprint 2, prototype improvement, startup metrics development, requirement traceability, and prototype testing | Improved HallPass prototype, richer review content and images, enhanced search/filter/sort controls, guide-detail pages, improved student and administrator dashboards, moderation and removal-request features, startup metrics documentation, testing notes, README update, screenshots, and weekly logbook | Completed |
| Lab 12 | Landing page development, digital go-to-market planning, acquisition metrics definition, marketing communication, CTA implementation, and repository documentation  | HallPass landing page, landing page content, go-to-market plan, marketing messages, acquisition metrics, acquisition tracking template, CTA interaction, landing page and CTA screenshots, README update, and weekly logbook  | Completed |
| Lab 13 | Sales scenario, demo script, user testing, and improvement planning | Sales scenario, demo script, user-testing plan/results, improvement list, demo flow, and pitch outline | Completed |
| Lab 14 | Final MVP release, traceability, demonstration, and reflection | Final Prototype  final report, traceability matrix, final demo| Completed |
