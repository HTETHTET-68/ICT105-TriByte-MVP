  ...
  footer.innerHTML = `
    <div class="container footer-grid">
      ...
      <div class="footer-simple-links">
        <h4>Project</h4>
        <span>ICT105 student prototype</span>
        <a href="README.md">Prototype guide</a>
        <a
              ...
              <div class="review-body">
                <div class="review-labels">
                  ...
                  <span class="verification-badge">
                    ...
                    ${escapeHtml(getVerificationLabel(review))}
                  </span>
                </div>
                ...
                <div class="card-actions">
                  ...
                  >Read More</a>
                  <button class="icon-text-button ${isFavorite(review.placeId) ? "active" : ""}"
                    type="button" data-favorite-place="${escapeHtml(review.placeId)}"
                    aria-pressed="${isFavorite(review.placeId)}">
                    <i class="${isFavorite(review.placeId) ? "fa-solid" : "fa-regular"} fa-bookmark"></i>
                    ${isFavorite(review.placeId) ? "Saved" : "Save"}
                  </button>
                </div>
              </div>
            </article>
