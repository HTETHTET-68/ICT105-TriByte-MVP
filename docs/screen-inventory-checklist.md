...
Every required screen designed during **Lab 05** must be carried forward into the final HallPass prototype. Each screen must be traceable to its corresponding functional requirements, user stories, feature mapping, and prototype implementation. Any additions, removals, or major modifications must be documented through GitHub Issues and the project's `weekly-logbook.md` before submission.
