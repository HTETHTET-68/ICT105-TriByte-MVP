...
| **US-09** | Admin | As an administrator, I want to view review statistics and moderation information, so that I can monitor the platform. | FR-11 | Should | Given I open the Dashboard page, when it loads, then I can view review statistics and moderation-related information. | `prototype/dashboard.html` |
