...
| US-17 | Student | As a first-year student, I want a "First Week Guide" section I can read through, so that I have one clear starting point instead of not knowing where to begin. | FR-05, FR-07 | Must | Given I open the First Week Guide from the homepage, when the page loads, then I see a structured list of topics (e.g., move-in, dining, orientation) that I can click into for detail. | Guide page screenshot (highest-requested feature: R003, R007, R014, R019) |
